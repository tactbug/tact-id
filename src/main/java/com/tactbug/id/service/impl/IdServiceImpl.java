...
public class IdServiceImpl implements IdService {
    ...
    @Override
    public Queue<Long> getSnowflakeId(String applicationName, String domainName, Integer quantity) {
        if (quantity > 300000 || quantity < 10000){
            throw new IllegalArgumentException("每个主体每次请求ID数不能大于300,000个或是小于10,000个");
        }
        DomainSequence domainSequence = new DomainSequence(applicationName, domainName);
